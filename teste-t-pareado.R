...
par(mfrow=c(2,2)) # Estabeleci que quero que os gráficos saiam na mesma linha
...
hist(dados$Convulsoes_PT, ylab="Quantidade de Convulsões", xlab="Pré-Tratamento")
hist(dados$Convulsoes_S1, ylab="Quantidade de Convulsões", xlab="1ª semana de Tratamento")
