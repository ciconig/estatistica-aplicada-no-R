...
dados %>% 
  ...
  labs(x = 'Nota em matemática', y = 'Até que série seu pai estudou?')
...
dados %>% 
  ...
  geom_errorbar(stat = "summary", width = 0.1,
                fun.min = "min", fun.max = "max",
                position = position_dodge(0.1)) + 
  labs(x = 'Nota em matemática', y = 'Até que série sua mãe estudou?')
...
dados %>% 
  ...
  geom_errorbar(stat = "summary", width = 0.1,
                fun.min = "min", fun.max = "max",
                position = position_dodge(0.1)) + 
  labs(x = 'Nota em matemática', y = 'Renda Mensal da Família')
